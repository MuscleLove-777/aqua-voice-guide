...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import AquaVoiceSEOOptimizer
        ...
        optimizer = AquaVoiceSEOOptimizer(config)
    ...
    try:
        from site_generator import AquaVoiceSiteGenerator
        site_gen = AquaVoiceSiteGenerator(config)
        site_gen.build_site()
